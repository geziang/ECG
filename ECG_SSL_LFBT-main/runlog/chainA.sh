...
echo "[$(date +%H:%M)] 车道A: M 第四批(跨域四件套) ==" >> "$SUM"
"$PY" m_screen.py --config runlog/M/matrix_batch4.yaml >> "$SUM" 2>&1
echo "[$(date +%H:%M)] 车道A: 第四批结束 ==" >> "$SUM"
